    ...
    <div>
        ...
        <div className="containerRowCards">
            <div className="rowCard">
                <h2 className="rowCardTitle"><Trans i18nKey="home.card1.title"/></h2>

                <div className="rowCardItem">
                    <img src={iconCarrot} alt="An orange carrot" width="12%" className="icon"></img>
                    <p className="rowCardItemAmount"><Trans i18nKey="home.card1.item1.amount"/></p>
                    <p className="rowCardItemText"><Trans i18nKey="home.card1.item1.concept"/></p>
                </div>
                <div className="rowCardItem">
                    <img src={iconSolarPanel} alt="A solar panel" width="12%" className="icon"></img>
                    <p className="rowCardItemAmount"><Trans i18nKey="home.card1.item2.amount"/></p>
                    <p className="rowCardItemText"><Trans i18nKey="home.card1.item2.concept"/></p>
                </div>
                <div className="rowCardItem">
                    <img src={iconElectricCar} alt="An electric car" width="12%" className="icon"></img>
                    <p className="rowCardItemAmount"><Trans i18nKey="home.card1.item3.amount"/></p>
                    <p className="rowCardItemText"><Trans i18nKey="home.card1.item3.concept"/></p>
                </div>
                <div className="rowCardButton">
                    <a href="compensate" className="rowCardButton"><Trans i18nKey="home.card1.button"/></a>
                </div>
            </div>
            <div className="rowCard">
                <h2 className="rowCardTitle"><Trans i18nKey="home.card2.title"/></h2>

                <div className="rowCardItem">
                    <img src={iconTree1} alt="A tree" width="12%" className="icon"></img>
                    <p className="rowCardItemAmount"><Trans i18nKey="home.card2.item1.amount"/></p>
                    <p className="rowCardItemText"><Trans i18nKey="home.card2.item1.concept"/></p>
                </div>
                <div className="rowCardItem">
                    <img src={iconTree2} alt="A tree" width="12%" className="icon"></img>
                    <p className="rowCardItemAmount"><Trans i18nKey="home.card2.item2.amount"/></p>
                    <p className="rowCardItemText"><Trans i18nKey="home.card2.item2.concept"/></p>
                </div>
                <div className="rowCardItem">
                    <img src={iconTree3} alt="A tree" width="12%" className="icon"></img>
                    <p className="rowCardItemAmount"><Trans i18nKey="home.card2.item3.amount"/></p>
                    <p className="rowCardItemText"><Trans i18nKey="home.card2.item3.concept"/></p>
                </div>
                <div className="rowCardButton">
                    <a href="how-it-works" className="rowCardButton"><Trans i18nKey="home.card2.button"/></a>
                </div>
            </div>
        </div>
